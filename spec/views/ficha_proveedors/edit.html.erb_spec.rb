...
RSpec.describe "ficha_proveedors/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit ficha_proveedor form" do
    render

    assert_select "form[action=?][method=?]", ficha_proveedor_path(@ficha_proveedor), "post" do
